...
class OverviewDataImpl @Inject constructor(
    ...
    */
    ...
    // rh.gs(app.aaps.core.ui.R.string.format_insulin_units, bolusIob(iobCobCalculator).iob + basalIob(iobCobCalculator).basaliob) // Tarciso Modificado de IOB. Apenas com IOB Bolus (sem IOB
        // BASAL)
        rh.gs(app.aaps.core.ui.R.string.format_insulin_units, bolusIob(iobCobCalculator).iob )
