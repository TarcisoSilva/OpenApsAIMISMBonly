...
import app.aaps.core.interfaces.notifications.Notification.Companion.VERSION_EXPIRE
...
class VersionCheckerPlugin @Inject constructor(
    ...
    enum class GracePeriod(val warning: Long, val old: Long, val veryOld: Long) {
        RELEASE(9999, 99999, 999999),
        RC(9999, 99999, 999999)
        // RELEASE(30, 60, 90),
        //         RC(2, 7, 14)
    ...
    override fun isClosedLoopAllowed(value: Constraint<Boolean>): Constraint<Boolean> {
        ...
        //    value.set(false, rh.gs(R.string.application_expired), this)
            value.set(true, "Loop permitido para sempre", this)
        return value
    }
      ...
      val now = dateUtil.now()
       ...
       //}
        ...
        if (endDate != 0L && dateUtil.now() > endDate && shouldWarnAgain()) {
            ...
            //notify
            uiInteraction.addNotification(VERSION_EXPIRE, rh.gs(R.string.application_expired), Notification.URGENT)
        }
    }
