...
*/
    ...
    override fun checkStaleBGAlert() {
        ...
        // Obtém a hora atual usando LocalTime
        val hour = LocalTime.now().hour

        // Se for entre 09:00 e 22:00, usa metade do valor especificado; senão, o valor total
        val threshold = if (hour in 8 until 22) {
            missedReadingsThreshold() / 2
        } else {
        ...
        if (sp.getBoolean(app.aaps.core.utils.R.string.key_enable_missed_bg_readings_alert, false)
            && bgReading.timestamp + threshold < System.currentTimeMillis()
