...
class SkinLowRes @Inject constructor(private val config: Config) : SkinInterface {
    ...
    override fun getOverviewLayoutId(): Int = R.layout.overview_fragment
    ...
    override fun preProcessLandscapeOverviewLayout(binding: OverviewFragmentBinding, isLandscape: Boolean, isTablet: Boolean, isSmallHeight: Boolean) {
        ...
        binding.apply {
            ...
            // activeProfile.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0) // Tarciso REMOVENDO O PROFILE da tela inicial
            infoLayout.tempTarget.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0) // Tarciso Change TT
        }
